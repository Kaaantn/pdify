  ...
  return (
    ...
    >
      ...
      <img
        ...
        style={{ boxShadow: selected ? "0 0 0 1.5px #9AAD2E" : undefined }}
      />
      {selected && (
        <>
          <div
            className="absolute -bottom-1.5 -right-1.5 h-3.5 w-3.5 cursor-se-resize rounded-sm bg-accent ring-1 ring-white"
            onMouseDown={(e) => startDrag(e, "resize")}
          />
          <div className="absolute -top-9 right-0 flex gap-1">
            <button
              type="button"
              className="flex h-7 w-7 items-center justify-center rounded-full bg-white text-muted-foreground shadow ring-1 ring-divider hover:bg-divider/40"
            ...
            <button
              type="button"
              className="flex h-7 w-7 items-center justify-center rounded-full bg-white text-red-500 shadow ring-1 ring-divider hover:bg-red-50"
              onMouseDown={(e) => e.stopPropagation()}
              onClick={(e) => {
                e.stopPropagation();
